import{d,u as _,a as u,c as m,b as p,r as h,e as s,f as t,t as a,g as n,F as f,h as g,n as v,i as x,o as r,j as b,k as y,l as N,m as k,_ as P}from"./index-b4040040.js";import{N as S}from"./NoteDisplay-7f61ca83.js";const w={class:"m-4"},V={class:"mb-10"},L={class:"text-4xl font-bold mt-2"},T={class:"opacity-50"},B={class:"text-lg"},D={class:"font-bold flex gap-2"},H={class:"opacity-50"},j=t("div",{class:"flex-auto"},null,-1),z={key:0,class:"border-gray-400/50 mb-8"},C=d({__name:"PresenterPrint",setup(F){_(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
